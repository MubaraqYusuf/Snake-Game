...
public class SetWallColor extends JDialog{
	 
	/**
	 * This class extends JDialog and appears a color selector 
	 * User picks the color he wants to add for wall
	 */
	
	private static final long serialVersionUID = 1L;
	
	//initialize WallColor
	...
	public JPanel getJContentPane() { 
		if (jContentPane == null) {
			selectedcolor = JColorChooser.showDialog(null, "Change Wall Color", WallColor);
