...
public class SetFoodColor extends JDialog{
	
	/**
	 * This class extends JDialog and appears a color selector 
	 * User picks the color he wants to add for food
	 */

	private static final long serialVersionUID = 1L;
	
	//initialize FoodColor
	static Color FoodColor = Color.ORANGE;
	...
	public JPanel getJContentPane() { 
	   if (jContentPane == null) {
		   selectedcolor = JColorChooser.showDialog(null, "Change Food Color", FoodColor);
	
		   //get the selected color
		   if (selectedcolor != null) {
	    	   FoodColor = selectedcolor;
		       jLabel = new JLabel();
