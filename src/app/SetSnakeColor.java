...
public class SetSnakeColor extends JDialog{
	
	/**
	 * This class extends JDialog and appears a color selector 
	 * User picks the color he wants to add for snake
	 */
	
	private static final long serialVersionUID = 1L;
	
	//initialize SnakeColor
	...
	public JPanel getJContentPane() { 
		if (jContentPane == null) {
			selectedcolor = JColorChooser.showDialog(null, "Change Snake Color", SnakeColor);
